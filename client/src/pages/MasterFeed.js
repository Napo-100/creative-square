...
const MasterFeed = () => {
  ...
  return (
    <div className="container pt-3">
      ...
      <div className="grid grid-cols-1 gap-1 md:grid-cols-2 md:gap-1 lg:grid-cols-3 lg:gap-1 xl:grid-cols-4 p-2">
        {posts.map((post) => (
          <div key={post._id} className="hover:bg-purple-400 bg-transparent rounded-lg">
